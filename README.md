This is a repository, to show online the toolkit of indicators developed for the Horizon BIOservicES, WP3.3.
The official read me is in the toolkit itself, that can be seen online, this file is just for the developers.
################################################################################################################
